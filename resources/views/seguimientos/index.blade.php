                      ...
                      <form action="{{route('seguimiento.store')}}" method="POST">
                        ...
                        <div class="input-group mb-3">
                           ...
                           <div class="input-group  mb-3">
                              ...
                              <input id="capacidad_compra" placeholder="Capacidad de Compra" class="form-control @error('capacidad_compra') is-invalid @enderror" type="text" name="capacidad_compra" value="{{old('capacidad_compra')}}" >
                           ...
                           <div class="input-group  mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="nota" class="form-control @error('nota') is-invalid @enderror" id="nota" rows="5" ></textarea>
                                @error('nota')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
